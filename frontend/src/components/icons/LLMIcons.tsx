/**
 * LLM Provider Icons
 * SVG icons for OpenAI, Anthropic, and Google Gemini
 */
...
export function AnthropicIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M13.827 3.52h3.603L24 20.48h-3.603l-6.57-16.96zm-7.257 0h3.604L16.744 20.48h-3.603L6.57 3.52zM0 20.48h3.604l1.31-3.374H9.5l.696 1.786H6.574l2.721-6.98 2.723 6.98h-3.62l1.31 3.374h3.603l-6.57-16.96H3.138L0 20.48z" />
    </svg>
  )
}
...
export function ClaudeCodeIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
// Helper to get icon by provider ID
