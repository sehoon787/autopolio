...
test.describe('Generate Page Structure', () => {
  ...
  test('should show empty project state when no projects', async ({ page }) => {
    ...
    await expect(page.getByText('No projects registered.')).toBeVisible({ timeout: 10000 })
  })
  ...
  test('should show Template Settings card', async ({ page }) => {
    ...
    await expect(page.getByText('Select Template')).toBeVisible({ timeout: 10000 })
  })
  ...
  test('should show Generation Options with checkboxes', async ({ page }) => {
    ...
    await expect(page.getByText('Include Achievements')).toBeVisible({ timeout: 10000 })
    await expect(page.getByText('Include Tech Stack')).toBeVisible({ timeout: 10000 })
  })
...
test.describe('Generate Page with Projects', () => {
  ...
  test('should show selected count after selecting a project', async ({ page }) => {
    ...
    await expect(page.getByText(/\d+ project\(s\) selected/)).toBeVisible({ timeout: 10000 })
  })
})
