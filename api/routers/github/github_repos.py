...
async def get_repo_quick_info(
    ...
    try:
        ...
        raise HTTPException(
            status_code=400, detail=f"Failed to fetch repo info: {str(e)}"
        )
...
async def get_file_tree(
    ...
    try:
        ...
        raise HTTPException(
            status_code=400, detail=f"Failed to get file tree: {str(e)}"
        )
...
async def get_file_content(
    ...
    try:
        ...
        raise HTTPException(
            status_code=400, detail=f"Failed to get file content: {str(e)}"
        )
...
async def detect_technologies(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Technology detection failed: {str(e)}"
        )
