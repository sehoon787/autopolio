...
class RoleService:
    ...
    TECH_ROLE_MAPPING = {
        'backend': [
            # Languages
            'python', 'java', 'kotlin', 'go', 'golang', 'rust', 'c#', 'csharp',
            'php', 'ruby', 'scala', 'elixir', 'erlang',
            # Frameworks
            'fastapi', 'django', 'flask', 'spring', 'spring boot', 'express',
            'nestjs', 'laravel', 'rails', 'ruby on rails', 'gin', 'echo',
            'actix', 'axum', 'asp.net', '.net core', 'grpc',
            # Databases
            'postgresql', 'postgres', 'mysql', 'mariadb', 'mongodb', 'redis',
            'elasticsearch', 'cassandra', 'dynamodb', 'sqlite', 'oracle',
            'sql server', 'neo4j', 'graphql', 'prisma',
            # Tools
            'celery', 'rabbitmq', 'kafka', 'nginx', 'apache',
        ],
        'frontend': [
            # Languages/Core
            ...
            'angular', 'angularjs', 'svelte', 'solid', 'preact', 'next.js',
            'nextjs', 'nuxt', 'nuxt.js', 'gatsby', 'remix', 'astro',
            # UI Libraries
            'tailwind', 'tailwindcss', 'bootstrap', 'material-ui', 'mui',
            'chakra', 'antd', 'ant design', 'styled-components', 'emotion',
            'shadcn', 'radix',
            # State Management
        ...
        'fullstack': [
            ...
            'mern', 'mean', 'lamp', 't3 stack',
        ],
        'mobile': [
            # Cross-platform
            'flutter', 'dart', 'react native', 'react-native', 'expo',
            'ionic', 'capacitor', 'xamarin', 'cordova', 'phonegap',
            # Native Android
            'android', 'kotlin', 'java android', 'android studio',
            'jetpack compose', 'room', 'retrofit',
            # Native iOS
        ...
        'data': [
            # Languages/Tools
            'python', 'r', 'julia', 'matlab', 'sas',
            # ML/DL Frameworks
            'tensorflow', 'pytorch', 'keras', 'scikit-learn', 'sklearn',
            'xgboost', 'lightgbm', 'catboost', 'huggingface', 'transformers',
            # Data Processing
            'pandas', 'numpy', 'scipy', 'dask', 'spark', 'pyspark',
            'hadoop', 'hive', 'presto', 'airflow', 'luigi',
            # Visualization
            'matplotlib', 'seaborn', 'plotly', 'bokeh', 'd3.js', 'tableau',
            # ML Ops
        ...
        'security': [
            ...
            'cryptography', 'oauth', 'jwt', 'keycloak', 'auth0',
            'vault', 'hashicorp vault', 'ssl', 'tls', 'encryption',
        ],
        'qa': [
            'testing', 'qa', 'quality assurance', 'test automation',
            'selenium', 'cypress', 'playwright', 'puppeteer',
            'jest', 'mocha', 'jasmine', 'pytest', 'junit',
            'testng', 'cucumber', 'behave', 'robot framework',
    ...
    def _score_from_files(self, file_patterns: List[str]) -> Dict[str, float]:
        ...
        file_role_mapping = {
            'backend': [
                ...
                r'requirements\.txt$', r'pom\.xml$', r'build\.gradle$',
                r'manage\.py$', r'settings\.py$', r'wsgi\.py$',
            ],
            'frontend': [
                r'\.(jsx?|tsx?|vue|svelte)$',
                r'(components?|pages?|views?|layouts?)/',
                r'(styles?|css|scss|sass)/',
                r'package\.json$', r'vite\.config', r'next\.config',
            ],
            'mobile': [
                r'\.(kt|swift|dart)$',
                r'(android|ios)/',
                r'pubspec\.yaml$', r'build\.gradle$', r'AppDelegate',
            ],
            'devops': [
