...
- **AI 코드 리뷰** (v1.20 신규)
  - PR 오픈/업데이트 시 Gemini 2.0 Flash API로 자동 리뷰
  - 버그, 보안, 성능, 코드 품질 검사
  - PR 댓글로 결과 게시 (기존 댓글 업데이트, 중복 방지)
  - `GEMINI_API_KEY` 미설정 시 graceful skip
- **보안 스캔**
...
상세 변경 이력은 `CHANGELOG.md` 참조. 현재 버전: **v1.20** (2026-02-24)

---

**문서 버전**: 1.20 | **최종 업데이트**: 2026-02-24 KST
